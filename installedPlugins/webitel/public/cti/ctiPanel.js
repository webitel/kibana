define(function (require) {
    ...
    require('plugins/webitel/cti/js/webitel_verto');
    require('plugins/webitel/cti/js/jquery.jscrollpane.min');
    require('plugins/webitel/cti/js/jquery.simplemodal.1.4.4.min');
    require('plugins/webitel/cti/js/jquery.selectBox');
    require('plugins/webitel/cti/css/style.css');
    require('plugins/webitel/cti/css/jquery.jscrollpane.css');
    require('plugins/webitel/cti/css/jquery.selectBox.css');
...
//WebitelSessionController.$inject = ['$scope','$injector'];
    ...
    function WebitelSessionController($scope, $rootScope) {
        var webitelPanel;
            ...
            function startWebphone() {
                ...
                injector.get('webitel').then(function(w) {
                    ...
                    webitelPanel = WebitelPanel({
                        defUserPic: '../plugins/webitel/cti/img/t-userpic_default__img.png',
