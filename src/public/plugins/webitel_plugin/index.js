...
define('webitel', ['require', 'angular', 'services/webitelSocket', 'text!config', 'components/webitel/hashCollection'], function (require) {
    ...
    require('modules').get('kibana')
        .service('webitel', function ($rootScope, $http) {
            ...
            */
            ...
            webitel.onServerEvent("CC::AGENT-STATE-CHANGE", function (e) {
                var userId = e['User-Domain'] + ':' + e['User-ID'];
                var agent = hashListAgent.get(userId);
                if (!agent) {
                    agent = hashListAgent.add(userId, {});
            ...
            webitel.onServerEvent("CC::AGENT-STATUS-CHANGE", function (e) {
                var userId = e['User-Domain'] + ':' + e['User-ID'];
                var agent = hashListAgent.get(userId);
                if (!agent) {
                    agent = hashListAgent.add(userId, {});
...
define('plugins/webitel_plugin/webitel_plugin_vis_controller',['require', 'services/webitelSocket', 'ng-table', 'modules', 'plugins/webitel_plugin/webitel_handler_type', 'webitel'],function (require) {
    require('ng-table');
    ...
    //var webitel = require('modules').get('kibana/webitel');
