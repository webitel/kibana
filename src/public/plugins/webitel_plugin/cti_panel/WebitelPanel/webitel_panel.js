/*
    WebitelPanel configuration sample
    {
         server_address: 'wss://pre.webitel.com:10022',
         user: '101@taras',
         password: '101',
         webrtc_server: 'wss://pre.webitel.com:8082',
         webrtc_domain: '@taras',
         agentLic: {},
         webrtc: true,
         domain: 'taras',
    ...
    injector.get('webitel').then(function(w) {debugger})

 'verto', 'jscrollpane', 'simplemodal', 'selectBox',
 */
...
define('plugins/webitel_plugin/cti_panel/WebitelPanel/webitel_panel', ['require', 'text!config', 'plugins/webitel_plugin/webitel', 'verto',  'jscrollpane', 'simplemodal', 'selectBox',  'css!plugins/webitel_plugin/cti_panel/WebitelPanel/css/style.css',
    ...
    var webitelSession = configFile.webitelSession;
    var webrtcConf = {};
    if (webitelSession) {
        webrtcConf["login"] = webitelSession.login;
        webrtcConf["password"] = webitelSession.password;
        webrtcConf["ws_servers"] = webitelSession.webrtc;
        webrtcConf["vertoRecordFile"] = "/other/elegant_ringtone.mp3";
    }
    module.controller('WebitelSession', WebitelSessionController)
    ...
    function WebitelSessionController($scope, localStorage) {
        ...
        $scope.useWebrtc = localStorage.get("useWebrtc");
        $scope.useWebrtcLeft = localStorage.get("useWebrtcLeft");
        ...
        $scope.save = function () {
            localStorage.set("useWebphone", !!$scope.useWebphone);
            localStorage.set("useWebrtc", !!$scope.useWebrtc);
            localStorage.set("useWebrtcLeft", !!$scope.useWebrtcLeft);
            location.reload();
        }
    ...
    WebitelPanel = function(configuration) {
